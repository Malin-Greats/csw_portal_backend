...
urlpatterns = [
    ...
    path('member-profile-detail/<str:pk>', views.member_profile_detail,
         name='member-profile-detail'),
    path('member-certificate-gen/<str:pk>', views.member_certificate_gen,
         name='member-certificate-gen'),
    path('member_confirm_payment/<str:pk>', views.member_confirm_payment,
