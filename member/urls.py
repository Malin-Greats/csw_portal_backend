...
urlpatterns = [
    ...
    path('member-profile-detail/<str:member_number>', views.member_profile_detail,
         name='member-profile-detail'),
    path('member-certificate-gen/<str:member_number>', views.member_certificate_gen,
         name='member-certificate-gen'),
    path('member_confirm_payment/<str:member_number>', views.member_confirm_payment,
